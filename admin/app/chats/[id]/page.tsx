...
import type { ChatInteraction, ChatSessionRow } from "@/lib/chats";
...
export default async function ChatSessionPage({
  ...
  const [{ data: sessions, error: listError }, { data: messages, error: threadError }, { count: unanswered }, { count: unread }] =
    await Promise.all([
      supabase
      ...
      supabase
        .from("interactions")
        .select("id, session_id, wa_message_id, wa_from, question, reply, language, outcome, created_at")
